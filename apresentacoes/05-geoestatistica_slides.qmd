...
- 🌽 **Agricultura de Precisão**: Análise da produtividade agrícola em diferentes talhões
...
📌 **Patamar ($C$)**: É o valor em que o variograma se estabiliza, indicando que a partir de certa distância, a variabilidade não aumenta mais.

📌 **Alcance ($a$)**: É a distância a partir da qual dois pontos deixam de estar correlacionados. Após essa distância, tornam-se independentes.
...
![](figuras/variograma2.png){fig-align="center" width="70%"}
...
### Vantagens sobre outros métodos (ex: IDW)

- É o **melhor estimador linear não viciado** (BLUE).
...
## Exemplo: Teor de Argila no Solo

![](figuras/geoestatistica7.png){fig-align="center" width="70%"}

<div style="font-size: 60%;">
Comparação de métodos de interpolação:
- **Krigagem**: Suavizado e robusto, considera a dependência espacial.
