...
[Clique aqui para acessar a apresentação em Slides](apresentacoes/02-tipos_dados_slides.html){target="_blank"}
:::

::: {.callout-important}
## Prática a respeito da Tipologia dos Dados Espaciais
[Clique aqui para acessar o material](apresentacoes/tarefa_mapas_tematicos_geobr.html){target="_blank"}
:::
